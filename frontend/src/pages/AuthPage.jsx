...
const AuthPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (result.success) {
        setToast({ type: 'success', message: 'Successfully signed in with Google!' });
        setTimeout(() => {
        ...
        <div className="glass-card p-8 glow-purple animate-scale-in">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              disabled={loading}
              className="btn-secondary py-2.5 text-sm flex items-center justify-center gap-2 disabled:opacity-50"
            >
